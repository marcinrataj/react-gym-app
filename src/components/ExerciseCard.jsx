...
export default function ExerciseCard(props) {
	...
	return (
		<div className='p-4 rounded-md flex flec-col gap-4 bg-slate-950 sm:flex-wrap mx-[50px]'>
    ...
    <div className='flex flex-col bg-slate-950 rounded gap-2 p-2'>
      {exercise.description.split('___').map((val, valInex)=> {
        return (
          <div className='text-sm' key={valInex}>
            {val}
          </div>
        )
})}
